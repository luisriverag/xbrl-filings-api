"""Define tests for download functions."""
...
# download_processor.download_parallel_async_iter
# download_processor._download_parallel_worker
# download_processor.validate_stem_pattern
